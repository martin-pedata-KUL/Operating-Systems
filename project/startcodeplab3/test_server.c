...
int main(int argc, char *argv[]) {
    ...
    do {
    	...
    	pthread_attr_init(attr); // Initialize attribute BEFORE creating thread
    	pthread_create(&tid[conn_counter], attr, runner, &client); // Thread tid[conn_counter] goes onto runner and executes there.
